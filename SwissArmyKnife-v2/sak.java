 ...
 * 
 * This file is the second version of the oriinal SwissArmyKnife(sak) project
 * 
 * This application uses the open source component HttpRequest.java
 * 
 * This application uses the main method code from Professor Pogue's Sleep,
 * SleepFast, and SleepFastImplementsRunnable files
 * 
 * This application uses the OneSecondSleeper class code from Professor
 * Pogue's Sleep, SleepFast, and SleepFastImplementsRunnable files and
 * modifies their names sleight
 */
...
public class sak
{
   static float startTime;             // is this the right place to initialize stuff
   ...
   private static void runHelp()
   {
      ...
      System.out.println("\nHow to Copy/Paste:");
      System.out.println("To Copy --> [ctrl + c]");
      System.out.println("To Paste --> [ctrl + v]");
